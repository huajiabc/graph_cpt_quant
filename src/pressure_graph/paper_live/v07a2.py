...
TRADE_COLUMNS = [
    ...
    "cluster_id_at_entry",
    "correlation_cluster_id_at_entry",
    "correlation_cluster_size_at_entry",
    "correlation_cluster_input_covered_at_entry",
    ...
    "btc_beta_7d_at_entry",
    "btc_corr_7d_at_entry",
    "symbol_volatility_percentile_at_entry",
...
def _simulate_trade(
    ...
    trade = {
        ...
        "correlation_cluster_id_at_entry": str(entry_row.get("correlation_cluster_id", "")),
        "correlation_cluster_size_at_entry": _safe_float(entry_row.get("correlation_cluster_size")),
        "correlation_cluster_input_covered_at_entry": bool(
            entry_row.get("correlation_cluster_input_covered", False)
        )
        if pd.notna(entry_row.get("correlation_cluster_input_covered", False))
        else False,
        ...
        "btc_beta_7d_at_entry": _safe_float(entry_row.get("btc_beta_7d")),
        "btc_corr_7d_at_entry": _safe_float(entry_row.get("btc_corr_7d")),
        "symbol_volatility_percentile_at_entry": _safe_float(entry_row.get("symbol_volatility_percentile")),
